...
class SplashSecondView extends StatefulWidget {
  @override
  _SplashSecondViewState createState() => _SplashSecondViewState();
}

class _SplashSecondViewState extends State<SplashSecondView> {
  @override
