...
import 'package:vanam_social/screens/components/bottom_bar/paint/half_painter.dart';
...
class ConvexBottomNavigation extends StatefulWidget {
  ...
  ConvexBottomNavigation(
      {required this.tabs,
        ...
        this.smallIconPadding = 8.0,
        this.bigIconPadding = 16.0})
...
class ConvexBottomNavigationState extends State<ConvexBottomNavigation>
  ...
  SvgPicture nextIcon = SvgPicture.asset("assets/images_ic_home_logo.svg");
  SvgPicture activeIcon = SvgPicture.asset("assets/images_ic_home_logo.svg");
